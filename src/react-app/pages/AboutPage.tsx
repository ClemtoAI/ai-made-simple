...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <HeroSection
        title="About Us"
        subtitle="AI doesn’t have to be confusing. Easy AI Guide aims to make it simple."
      />
        ...
        <div className="bg-white rounded-lg shadow-md p-8 border border-gray-200">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              AI tools like ChatGPT, Claude, and Gemini are changing how people work, learn, and create. But for many, getting started feels overwhelming — too much jargon and fear of “doing it wrong.” We’re here to remove that confusion and show you how simple and useful AI can be.
            </p>
