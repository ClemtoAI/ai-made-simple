  ...
  return (
    <>
      <HeroSection
        ...
        subtitle="Find the right AI tools for your needs. Each tool includes beginner-friendly explanations and honest reviews."
      />
        ...
        <section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {beginnerTools.map((tool) => (
              <div key={tool.id} className="bg-white rounded-lg shadow-md p-6 border border-gray-200 flex flex-col" style={{ minHeight: '480px' }}>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTools.map((tool) => (
              <div key={tool.id} className="bg-white rounded-lg shadow-md p-6 border border-gray-200 flex flex-col" style={{ minHeight: '300px' }}>
